...
namespace Cyra.Data.Migrations
{
    ...
    [Migration("20250924172708_AddAdministrador")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cyra.Data.Administrador", b =>
                {
                    ...
                    b.ToTable("Administrador", "New_schema");
                });
                    ...
                    b.ToTable("Usuario", "New_schema", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Usuario_TipoUsuario", "\"TipoUsuario\" IN ('CLIENTE', 'VENDEDOR', 'ADMINISTRADOR')");
                        });
                });
            ...
            modelBuilder.Entity("Cyra.Data.Administrador", b =>
                {
                    b.HasOne("Cyra.Data.Usuario", "Usuario")
                        ...
                        .HasForeignKey("Cyra.Data.Administrador", "IdUsuario")
